$(document).ready(function() {
  ...
  // We're going to pass a proxied collection to a proxied collection
  // to make sure we can stack them.

  function getProxyCollection(coll) {
    var a = {};
    var b = {};

    proxyCollection(coll, a);
    proxyCollection(a, b);
  ...
  module("Proxied Collection Inception", _.extend(new Environment, {
